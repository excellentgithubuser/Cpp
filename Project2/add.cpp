...
string add_positive_integers(string a,string b)  //compute the sum of two positive integers (may be large numbers)
{
...
string add_positive(string a,string b)  //compute the sum of two positive numbers which have normal/decimal/SCM formal
{
    ...
    if ((isNum(a)==1 or isDecimal(a)==1 or isScientific_counting_method(a)==1)&&(isNum(b)==1 or isDecimal(b)==1 or isScientific_counting_method(b)==1))
    {
        ...
        string ans1=add_positive_integers(aa,bb);
...
string add(string a,string b)  //compute the sum of two numbers which have normal/decimal/SCM formal and use the standard form
{
    string result="";
